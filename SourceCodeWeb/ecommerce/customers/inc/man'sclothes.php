<section class="w-11/12 mx-auto mt-16">
    <div class="text-center">
        ...
        <h4 class="text-semibold text-4xl my-5">MEN'S CLOTHES</h4>
        <p class="text-gray-600 text-base">Quần áo làm nên con người. Những kẻ trần truồng không có hay có rất ít ảnh hưởng lên xã hội.
        </p>
    </div>
    ...
    <div class="text-center mt-6">
        <a href="index.php?page=products&cat_id=1&trang=1" class="text-xl py-3 px-16 md:px-8 bg-orange-300 hover:bg-orange-400 hover:text-black duration-300 text-white rounded-sm">
            Xem Thêm
        </a>
    </div>
</section>