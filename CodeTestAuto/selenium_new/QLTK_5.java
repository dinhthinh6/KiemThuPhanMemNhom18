...
public class QLTK_5 {
    static WebDriver driver;
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            driver.findElement(By.name("user_firstname")).sendKeys("Tao Manh Duc");
            Thread.sleep(1000);
            driver.findElement(By.name("user_numberphone")).clear();
            driver.findElement(By.name("user_numberphone")).sendKeys("012344566");
            Thread.sleep(1000);
            driver.findElement(By.name("user_email")).clear();
            driver.findElement(By.name("user_email")).sendKeys("abc@.com");
            Thread.sleep(1000);
