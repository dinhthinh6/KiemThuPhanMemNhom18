...
public class ThongKe_2 {
    static WebDriver driver;
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            System.out.print("So luong don hang luc dau: ");
            System.out.println(driver.findElement(By.xpath("/html/body/div/div[2]/div/div[2]/div")).getText());
            Thread.sleep(1000);
            //driver.quit();
            driver.get("http://localhost:8080/ecommerce/customers/index.php");
            //driver.quit();
            ...
            Thread.sleep(1000);
            driver.findElement(By.linkText("Dashboard")).click();
            System.out.print("So luong don hang sau khi dau : ");
            System.out.println(driver.findElement(By.xpath("/html/body/div/div[2]/div/div[2]/div")).getText());
            Thread.sleep(1000);
            driver.quit();
        }
